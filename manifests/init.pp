...
class elasticsearch (
  ...
  Boolean                                             $restart_config_change,
  Boolean                                             $restart_package_change,
  Boolean                                             $restart_plugin_change,
  Optional[Hash]                                      $roles,
  ...
  Enum['enabled', 'disabled', 'running', 'unmanaged'] $status,
