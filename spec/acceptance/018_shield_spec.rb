  ...
  describe server(:container) do
    ...
    describe 'user authentication' do
      ...
      describe http(
        ...
        it 'denies unauthorized access', :http do
      ...
      describe http(
        ...
        it 'permits authorized access', :http do
    ...
    describe 'changing passwords' do
      ...
      describe http(
        ...
        it 'authorizes changed passwords', :http do
          expect(response.status).to eq(200)
        end
      end
    end
    ...
    describe 'role permission control' do
      ...
      describe http(
        ...
        it 'denies stats API access', :http do
      ...
      describe http(
        ...
        it 'permits health API access', :http do
          expect(response.status).to eq(200)
        end
      end
    end
    ...
    describe 'tls' do
      ...
      describe 'single instance' do
        ...
        describe http(
          ...
          it 'permits TLS health API access', :http do
            expect(response.status).to eq(200)
          end
        end
      end
